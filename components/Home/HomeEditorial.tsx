...
export default function HomeEditorial() {
  return (
    <section aria-label="Editorial" className="px-4 md:px-0 py-14">
      <div className="mx-auto max-w-xl md:max-w-3xl bg-[var(--surface)] text-[var(--surface-foreground)] rounded-3xl ring-1 ring-[var(--border)] shadow-md px-6 md:px-8 py-10 text-center space-y-4">
        ...
        >
          Quiénes somos <span aria-hidden="true">→</span>
        </Link>
      </div>
    </section>
  );
