...
export default function HomeEditorial() {
  return (
    <section
      ...
      className="mx-auto md:max-w-6xl px-4 md:px-0 py-14 bg-[var(--surface-alt)] text-[var(--surface-foreground)] rounded-3xl ring-1 ring-[var(--border)] shadow-md"
    >
      <div className="max-w-3xl mx-auto text-center space-y-4">
        <h2 className="ty-h2">Universo Kiso</h2>
        <p className="ty-body text-[var(--surface-foreground)]/85">
